...
public class TestJDBC {
    ...
    public List<String> executerTests( HttpServletRequest request ) {
        ...
        try {
            ...
            int statut = statement.executeUpdate( "INSERT INTO Utilisateur (email, mot_de_passe, nom, date_inscription, naissance) VALUES ('jmarc22@mail.fr', MD5('lavieestbelle78'), 'jean-marc', NOW(), '85/12/12');" , Statement.RETURN_GENERATED_KEYS);
            ...
            resultat = statement.executeQuery( "SELECT id, email, mot_de_passe, nom, naissance, date_inscription FROM Utilisateur;" );
            ...
            while ( resultat.next() ) {
                ...
                String dateInsUtilisateur = resultat.getString("date_inscription");
                /* Formatage des données pour affichage dans la JSP finale. */
                messages.add( "Données retournées par la requête : id = " + idUtilisateur + ", email = " + emailUtilisateur
                        + ", motdepasse = "
                        + motDePasseUtilisateur + ", nom = " + nomUtilisateur + ", date de naissance :" + naissanceUtilisateur + ", inscrit le : " + dateInsUtilisateur );
            }
